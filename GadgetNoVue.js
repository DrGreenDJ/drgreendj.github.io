...
import { defineComponent, ref, watch, onMounted, createElementBlock, openBlock, createElementVNode, withDirectives, vModelText, toDisplayString, normalizeStyle, Fragment, renderList, onUnmounted, createCommentVNode, unref, vModelSelect, vModelCheckbox, vShow, createVNode, createBlock, defineCustomElement } from "vue";
(function polyfill() {
    ...
    !function(e, t) {
      ...
      return function(e) {
        ...
        (function(e2, r, i) {
          ...
          t.a = { isArray: f, isArrayBuffer: p, isBuffer: function(e3) {
            ...
            let t2;
            return t2 = "undefined" != typeof ArrayBuffer && ArrayBuffer.isView ? ArrayBuffer.isView(e3) : e3 && e3.buffer && p(e3.buffer), t2;
        ...
        e.exports = function(e2) {
          ...
          (v = g || (g = {})).Debounce = function(e3 = 250) {
            return function(t3, n3, r2) {
              let i2;
              return p({ target: t3, key: n3, descriptor: r2 }, function(t4, n4) {
            ...
            return function(n3, r2, i2) {
              return p({ target: n3, key: r2, descriptor: i2 }, function(n4, i3) {
            ...
            return function(t3, n3, r2) {
              return p({ target: t3, key: n3, descriptor: r2 }, function(t4, r3, i2) {
            ...
            return function(e3, t3, n3) {
              return p({ target: e3, key: t3, descriptor: n3 }, function(e4, n4) {
    ...
    o=(e,t,r,i)=>{const s=performance.now();
        ...
        (function(e2) {
          ...
          t.a = function(t2, n2, l) {
            ...
            })).metaTokens, f = l.visitor || m, h = l.dots, p = l.indexes, g = (l.Blob || "undefined" != typeof Blob && Blob) && r.a.isSpecCompliantForm(n2);
            ...
            function m(e3, t3, i2) {
              ...
              if (e3 && !i2 && "object" == typeof e3) {
                if (r.a.endsWith(t3, "{}")) t3 = d ? t3 : t3.slice(0, -2), e3 = JSON.stringify(e3);
                  ...
                  !r.a.isUndefined(e4) && null !== e4 && n2.append(true === p ? u([t3], i3, h) : null === p ? t3 : t3 + "[]", v(e4));
                }), false;
              }
        ...
        var r, i, o, s, a, u, c, l = n(19), d = n(36), f = Function.prototype.apply, h = Function.prototype.call, p = Object.create, g = Object.defineProperty, v = Object.defineProperties, m = Object.prototype.hasOwnProperty, y = { configurable: true, enumerable: false, writable: true };
        i = function(e2, t2) {
          var n2, i2;
          ...
          var n2;
          return d(t2), m.call(this, "__ee__") ? n2 = this.__ee__ : (n2 = y.value = p(null), g(this, "__ee__", y), y.value = null), n2[e2] ? "object" == typeof n2[e2] ? n2[e2].push(t2) : n2[e2] = [n2[e2], t2] : n2[e2] = t2, this;
          ...
          return null == e2 ? p(c) : v(Object(e2), u);
        }, t.methods = a;
      }, function(e, t) {
        var n;
        n = /* @__PURE__ */ function() {
        ...
        i.nextTick = function(e2) {
          ...
          c.push(new p(e2, t2)), 1 !== c.length || l || a(h);
        ...
        var ct = function() {
          ...
          e2.fromOpts = function(t3) {
            ...
            return new e2(o2 || (i2 ? "en-US" : function() {
              ...
              return at = "en-US";
            }()), n2 || tt.defaultNumberingSystem, r2 || tt.defaultOutputCalendar, o2);
        ...
        var cn = function() {
          ...
          e2.fromMillis = function(t3, n2) {
            ...
            if (tt.throwOnInvalid) throw new v(r2);
          ...
          return t2.toFormat = function(e3, t3) {
            ...
            for (var i2, o2, s2 = {}, a2 = {}, u2 = this.toObject(), c2 = f(on); !(o2 = c2()).done; ) {
              ...
              if (n2.indexOf(l2) >= 0) {
                ...
                W(u2[l2]) && (d2 += u2[l2]);
                var p2 = Math.trunc(d2);
                for (var g2 in s2[l2] = p2, a2[l2] = d2 - p2, u2) on.indexOf(g2) > on.indexOf(l2) && un(this.matrix, u2, g2, s2, l2);
        ...
        var hn = function() {
          ...
          e2.invalid = function(t3, n2) {
            ...
            var r2 = t3 instanceof Pe ? t3 : new Pe(t3, n2);
            if (tt.throwOnInvalid) throw new g(r2);
            return new e2({ invalid: r2 });
        ...
        function _n(e2, t2, n2) {
          var r2 = function(e3, t3) {
            ...
            return n3 = t3, i3 = bn(r3 = e2), o3 = bn(r3, "{2}"), s3 = bn(r3, "{3}"), a3 = bn(r3, "{4}"), u3 = bn(r3, "{6}"), c3 = bn(r3, "{1,2}"), l3 = bn(r3, "{1,3}"), d3 = bn(r3, "{1,6}"), f3 = bn(r3, "{1,9}"), h3 = bn(r3, "{2,4}"), p3 = bn(r3, "{4,6}"), g3 = function(e3) {
            ...
            var n3, r3, i3, o3, s3, a3, u3, c3, l3, d3, f3, h3, p3, g3, v2;
          ...
          }(f2) : [null, null], p2 = h2[0], g2 = h2[1];
          if (ee(f2, "a") && ee(f2, "H")) throw new m("Can't include meridiem when specifying 24-hour format");
          return { input: t2, tokens: r2, regex: c2, rawMatches: d2, matches: f2, result: p2, zone: g2 };
        }
        ...
        function er(e2, t2) {
          var n2 = t2.suppressSeconds, r2 = void 0 !== n2 && n2, i2 = t2.suppressMilliseconds, o2 = void 0 !== i2 && i2, s2 = t2.includeOffset, a2 = t2.includePrefix, u2 = void 0 !== a2 && a2, c2 = t2.includeZone, l2 = void 0 !== c2 && c2, d2 = t2.spaceZone, f2 = void 0 !== d2 && d2, h2 = t2.format, p2 = void 0 === h2 ? "extended" : h2, g2 = "basic" === p2 ? "HHmm" : "HH:mm";
          r2 && 0 === e2.second && 0 === e2.millisecond || (g2 += "basic" === p2 ? "ss" : ":ss", o2 && 0 === e2.millisecond || (g2 += ".SSS")), (l2 || s2) && f2 && (g2 += " "), l2 ? g2 += "z" : s2 && (g2 += "basic" === p2 ? "ZZZ" : "ZZ");
          var v2 = Qn(e2, g2);
        ...
        function ur(e2, t2) {
          ...
          var s2 = tt.now(), a2 = $n(e2, t2.offset(s2), t2), u2 = a2[0], c2 = a2[1];
        ...
        var lr = function() {
          function e2(e3) {
            var t3 = e3.zone || tt.defaultZone, n2 = e3.invalid || (Number.isNaN(e3.ts) ? new Pe("invalid input") : null) || (t3.isValid ? null : Jn(t3));
            this.ts = Z(e3.ts) ? tt.now() : e3.ts;
            var r2 = null, i2 = null;
          ...
          e2.now = function() {
            ...
            return Z(t3) ? e2.now() : ur({ year: t3, month: n2, day: r2, hour: i2, minute: o2, second: s2, millisecond: a2 }, tt.defaultZone);
          }, e2.utc = function(t3, n2, r2, i2, o2, s2, a2) {
            return Z(t3) ? new e2({ ts: tt.now(), zone: Ze.utcInstance }) : ur({ year: t3, month: n2, day: r2, hour: i2, minute: o2, second: s2, millisecond: a2 }, Ze.utcInstance);
            ...
            if (void 0 === n2 && (n2 = {}), W(t3)) return t3 < -864e13 || t3 > 864e13 ? e2.invalid("Timestamp out of range") : new e2({ ts: t3, zone: Ge(n2.zone, tt.defaultZone), loc: ft.fromObject(n2) });
            throw new w("fromMillis requires a numerical input, but received a " + typeof t3 + " with value " + t3);
          }, e2.fromSeconds = function(t3, n2) {
            if (void 0 === n2 && (n2 = {}), W(t3)) return new e2({ ts: 1e3 * t3, zone: Ge(n2.zone, tt.defaultZone), loc: ft.fromObject(n2) });
            throw new w("fromSeconds requires a numerical input");
          }, e2.fromObject = function(t3) {
            var n2 = Ge(t3.zone, tt.defaultZone);
            if (!n2.isValid) return e2.invalid(Jn(n2));
            var r2 = tt.now(), i2 = n2.offset(r2), o2 = ge(t3, ar, ["zone", "locale", "outputCalendar", "numberingSystem"]), s2 = !Z(o2.ordinal), a2 = !Z(o2.year), u2 = !Z(o2.month) || !Z(o2.day), c2 = a2 || u2, l2 = o2.weekYear || o2.weekNumber, d2 = ft.fromObject(t3);
            ...
            var h2, p2, g2 = l2 || o2.weekday && !c2, v2 = Yn(r2, i2);
            g2 ? (h2 = or, p2 = nr, v2 = Un(v2)) : s2 ? (h2 = sr, p2 = rr, v2 = Fn(v2)) : (h2 = ir, p2 = tr);
            for (var y2, w2 = false, b2 = f(h2); !(y2 = b2()).done; ) {
              var E2 = y2.value;
              Z(o2[E2]) ? o2[E2] = w2 ? p2[E2] : v2[E2] : w2 = true;
            }
            ...
            var r2 = t3 instanceof Pe ? t3 : new Pe(t3, n2);
            if (tt.throwOnInvalid) throw new p(r2);
            return new e2({ invalid: r2 });
        ...
        t.DateTime = lr, t.Duration = cn, t.FixedOffsetZone = Ze, t.IANAZone = He, t.Info = pn, t.Interval = hn, t.InvalidZone = We, t.LocalZone = Ue, t.Settings = tt, t.VERSION = "1.28.1", t.Zone = je;
      }, function(e, t, n) {
        var r = n(39);
        e.exports = function(e2) {
          ...
          !function(e3, n2) {
            if (!e3.setImmediate) {
              ...
              f = f && f.setTimeout ? f : e3, "[object process]" === {}.toString.call(e3.process) ? r = function(e4) {
                ...
                t3.source === e3 && "string" == typeof t3.data && 0 === t3.data.indexOf(s) && p(+t3.data.slice(s.length));
        ...
        (function(e2) {
          ...
          function c(e3, t2, n2, r2) {
            ...
            return "undefined" != typeof ArrayBuffer && t2 instanceof ArrayBuffer ? function(e4, t3, n3, r3) {
              ...
              var r3 = 0 | p(t3, n3), i2 = (e4 = a(e4, r3)).write(t3, n3);
        ...
        t.read = function(e2, t2, n, r, i) {
          ...
          var s, a, u, c = 8 * o - i - 1, l = (1 << c) - 1, d = l >> 1, f = 23 === i ? Math.pow(2, -24) - Math.pow(2, -77) : 0, h = r ? 0 : o - 1, p = r ? 1 : -1, g = t2 < 0 || 0 === t2 && 1 / t2 < 0 ? 1 : 0;
          for (t2 = Math.abs(t2), isNaN(t2) || t2 === 1 / 0 ? (a = isNaN(t2) ? 1 : 0, s = l) : (s = Math.floor(Math.log(t2) / Math.LN2), t2 * (u = Math.pow(2, -s)) < 1 && (s--, u *= 2), (t2 += s + d >= 1 ? f / u : f * Math.pow(2, 1 - d)) * u >= 2 && (s++, u /= 2), s + d >= l ? (a = 0, s = l) : s + d >= 1 ? (a = (t2 * u - 1) * Math.pow(2, i), s += d) : (a = t2 * Math.pow(2, d - 1) * Math.pow(2, i), s = 0)); i >= 8; e2[n + h] = 255 & a, h += p, a /= 256, i -= 8) ;
          for (s = s << i | a, c += i; c > 0; e2[n + h] = 255 & s, h += p, s /= 256, c -= 8) ;
          e2[n + h - p] |= 128 * g;
        };
      }, function(e, t) {
        var n = {}.toString;
          ...
          !function(t2) {
            ...
            function m() {
              return this.bodyUsed = false, this._initBody = function(e3) {
                ...
                if (r3) return r3;
                if (this._bodyBlob) return e3 = this._bodyBlob, t3 = new FileReader(), n3 = p(t3), t3.readAsText(e3), n3;
        ...
        } }, p = { name: "querystring", lookup: function(e2) {
          var t2;
        ...
        }, p = n(1), g = { silentJSONParsing: true, forcedJSONParsing: true, clarifyTimeoutError: false }, v = { isBrowser: true, classes: { URLSearchParams: "undefined" != typeof URLSearchParams ? URLSearchParams : l, FormData: "undefined" != typeof FormData ? FormData : null, Blob: "undefined" != typeof Blob ? Blob : null }, protocols: ["http", "https", "file", "blob", "url", "data"] };
        ...
        const O = { transitional: g, adapter: ["xhr", "http", "fetch"], transformRequest: [function(e2, t2) {
          ...
          if (e2 && i.a.isString(e2) && (n2 && !this.responseType || r2)) {
            ...
            try {
              ...
              if (n3) {
                if ("SyntaxError" === e3.name) throw p.a.from(e3, p.a.ERR_BAD_RESPONSE, this, null, this.response);
                throw e3;
              }
            }
          }
        ...
        function M(e2, t2, n2) {
          p.a.call(this, null == e2 ? "canceled" : e2, p.a.ERR_CANCELED, t2, n2), this.name = "CanceledError";
        }
        i.a.inherits(M, p.a, { __CANCEL__: true });
        var P = M, j = n(12);
        function V(e2, t2, n2) {
          const r2 = n2.config.validateStatus;
          n2.status && r2 && !r2(n2.status) ? t2(new p.a("Request failed with status code " + n2.status, [p.a.ERR_BAD_REQUEST, p.a.ERR_BAD_RESPONSE][Math.floor(n2.status / 100) - 4], n2.config, n2.request, n2)) : e2(n2);
        }
        ...
        var $ = "undefined" != typeof XMLHttpRequest && function(e2) {
          return new Promise(function(t2, n2) {
            ...
            y2.open(r2.method.toUpperCase(), r2.url, true), y2.timeout = r2.timeout, "onloadend" in y2 ? y2.onloadend = w2 : y2.onreadystatechange = function() {
              ...
              y2 && (n2(new p.a("Request aborted", p.a.ECONNABORTED, e2, y2)), y2 = null);
            }, y2.onerror = function() {
              n2(new p.a("Network Error", p.a.ERR_NETWORK, e2, y2)), y2 = null;
            }, y2.ontimeout = function() {
              let t3 = r2.timeout ? "timeout of " + r2.timeout + "ms exceeded" : "timeout exceeded";
              const i2 = r2.transitional || g;
              r2.timeoutErrorMessage && (t3 = r2.timeoutErrorMessage), n2(new p.a(t3, i2.clarifyTimeoutError ? p.a.ETIMEDOUT : p.a.ECONNABORTED, e2, y2)), y2 = null;
            ...
            b2 && -1 === S.protocols.indexOf(b2) ? n2(new p.a("Unsupported protocol " + b2 + ":", p.a.ERR_BAD_REQUEST, e2)) : y2.send(o2 || null);
          });
        };
        var K = (e2, t2) => {
          ...
          if (t2 || n2) {
            ...
            const o2 = function(e3) {
              if (!n3) {
                ...
                r2.abort(t3 instanceof p.a ? t3 : new P(t3 instanceof Error ? t3.message : t3));
              }
            };
            let s2 = t2 && setTimeout(() => {
              s2 = null, o2(new p.a(`timeout ${t2} of ms exceeded`, p.a.ETIMEDOUT));
            }, t2);
            const a2 = () => {
        ...
        te && (ce = new Response(), ["text", "arrayBuffer", "blob", "formData", "stream"].forEach((e2) => {
          !ue[e2] && (ue[e2] = i.a.isFunction(ce[e2]) ? (t2) => t2[e2]() : (t2, n2) => {
            throw new p.a(`Response type '${e2}' is not supported`, p.a.ERR_NOT_SUPPORT, n2);
          });
        }));
        ...
        var de = te && (async (e2) => {
          ...
          try {
            ...
            l2 = l2 || "text";
            let p2 = await ue[i.a.findKey(ue, l2) || "text"](s3, e2);
            return !a3 && m2 && m2(), await new Promise((t3, n3) => {
              V(t3, n3, { data: p2, headers: _.from(s3.headers), status: s3.status, statusText: s3.statusText, config: e2, request: g2 });
            });
          } catch (t3) {
            if (m2 && m2(), t3 && "TypeError" === t3.name && /fetch/i.test(t3.message)) throw Object.assign(new p.a("Network Error", p.a.ERR_NETWORK, e2, g2), { cause: t3.cause || t3 });
            throw p.a.from(t3, t3 && t3.code, e2, g2);
          }
        });
        ...
        var ge = (e2) => {
          ...
          for (let i2 = 0; i2 < t2; i2++) {
            let t3;
            if (n2 = e2[i2], r2 = n2, !pe(n2) && (r2 = fe[(t3 = String(n2)).toLowerCase()], void 0 === r2)) throw new p.a(`Unknown adapter '${t3}'`);
            if (r2) break;
            o2[t3 || "#" + i2] = r2;
          }
          if (!r2) {
            ...
            throw new p.a("There is no suitable adapter to dispatch the request " + n3, "ERR_NOT_SUPPORT");
          }
          return r2;
        };
        function ve(e2) {
        ...
        ye.transitional = function(e2, t2, n2) {
          ...
          return (n3, i2, o2) => {
            if (false === e2) throw new p.a(r2(i2, " has been removed" + (t2 ? " in " + t2 : "")), p.a.ERR_DEPRECATED);
        ...
        var be = { assertOptions: function(e2, t2, n2) {
          if ("object" != typeof e2) throw new p.a("options must be an object", p.a.ERR_BAD_OPTION_VALUE);
          ...
          for (; i2-- > 0; ) {
            ...
            if (s2) {
              ...
              if (true !== n3) throw new p.a("option " + o2 + " must be " + n3, p.a.ERR_BAD_OPTION_VALUE);
            } else if (true !== n2) throw new p.a("Unknown option " + o2, p.a.ERR_BAD_OPTION);
          }
        }, validators: ye };
        ...
        Ie.Axios = ke, Ie.CanceledError = P, Ie.CancelToken = Te, Ie.isCancel = D, Ie.VERSION = "1.7.7", Ie.toFormData = s.a, Ie.AxiosError = p.a, Ie.Cancel = Ie.CanceledError, Ie.all = function(e2) {
        ...
        class I {
          ...
          init(e2) {
            e2 && (this.SERVICE = e2), this.checkService() && (this.sourceActionsChannels = { fireGeneralSilentNotification: f(this.SERVICE), fireGeneralAutoDismissNotification: h(this.SERVICE), fireGeneralAcknowledgeNotification: g(this.SERVICE), addCustomTask: m(this.SERVICE), getToken: y(this.SERVICE), getTaskMap: b(this.SERVICE), getMediaTypeQueue: S(this.SERVICE), getIdleCodes: O(this.SERVICE), getWrapUpCodes: C(this.SERVICE) }, this.destinationActionsChannels = { fireGeneralAutoDismissNotification: p(this.SERVICE), fireGeneralAcknowledgeNotification: v(this.SERVICE), getToken: w(this.SERVICE), getTaskMap: E(this.SERVICE), getMediaTypeQueue: k(this.SERVICE), getIdleCodes: T(this.SERVICE), getWrapUpCodes: A(this.SERVICE) }, this.logger.info("Inited"));
          }
          cleanup() {
        ...
        class B {
          ...
          fetchLatestData() {
            ...
            return q(this, void 0, void 0, function* () {
              ...
              if (s2) {
                const { teams: e3, agentName: t3, agentProfileID: n3, defaultDn: a2, agentSubStatus: u2, agentStatus: c2, idleCodes: l2, wrapupCodes: d2, dialPlan: f2, isOutboundEnabledForTenant: h2, isOutboundEnabledForAgent: p2, isAdhocDialingEnabled: g2, isEndCallEnabled: v2, isEndConsultEnabled: m2, allowConsultToQueue: y2, isAgentAvailableAfterOutdial: w2, isCampaignManagementEnabled: b2, agentPersonalStatsEnabled: E2 } = s2;
                let { idleCode: S2 } = s2;
                const k2 = a2;
                let O2 = c2, T2 = u2;
        ...
        const Se = o(i, "[AGENT CONFIG JSAPI] =>"), ke = (() => {
          ...
          }), { config: e2, logger: n2, monitoring: l2, shortcutKey: r2, actions: o2, agentContact: u2, agentStateInfo: s2, dialer: c2, screenpop: d2, i18n: h2, rtdwc: p2, postInteractions: g2, logout: f2, agentConfigJsApi: v2 };
        })();
      }, function(e, t, n) {
        ...
        var h = function(e2, t2, n2) {
          ...
          var p2 = void 0 !== e2.msecs ? e2.msecs : (/* @__PURE__ */ new Date()).getTime(), g2 = void 0 !== e2.nsecs ? e2.nsecs : f + 1, v2 = p2 - d + (g2 - f) / 1e4;
          if (v2 < 0 && void 0 === e2.clockseq && (a2 = a2 + 1 & 16383), (v2 < 0 || p2 > d) && void 0 === e2.nsecs && (g2 = 0), g2 >= 1e4) throw new Error("uuid.v1(): Can't create more than 10M uuids/sec");
          d = p2, f = g2, c = a2;
          var m2 = (1e4 * (268435455 & (p2 += 122192928e5)) + g2) % 4294967296;
          i2[r2++] = m2 >>> 24 & 255, i2[r2++] = m2 >>> 16 & 255, i2[r2++] = m2 >>> 8 & 255, i2[r2++] = 255 & m2;
          var y2 = p2 / 4294967296 * 1e4 & 268435455;
        ...
        var T = p("v5", 80, function(e2) {
          ...
          for (a2[s2 - 1][14] = 8 * (e2.length - 1) / Math.pow(2, 32), a2[s2 - 1][14] = Math.floor(a2[s2 - 1][14]), a2[s2 - 1][15] = 8 * (e2.length - 1) & 4294967295, i2 = 0; i2 < s2; i2++) {
            ...
            var d2 = n2[0], f2 = n2[1], h2 = n2[2], p2 = n2[3], g2 = n2[4];
            for (l2 = 0; l2 < 80; l2++) {
              var v2 = Math.floor(l2 / 20), m2 = O(d2, 5) + k(v2, f2, h2, p2) + g2 + t2[v2] + c2[l2] >>> 0;
              g2 = p2, p2 = h2, h2 = O(f2, 30) >>> 0, f2 = d2, d2 = m2;
            }
            n2[0] = n2[0] + d2 >>> 0, n2[1] = n2[1] + f2 >>> 0, n2[2] = n2[2] + h2 >>> 0, n2[3] = n2[3] + p2 >>> 0, n2[4] = n2[4] + g2 >>> 0;
          }
        ...
        var p = { type: "logger", log: function(e2) {
          this.output("log", e2);
        }, warn: function(e2) {
          this.output("warn", e2);
        }, error: function(e2) {
          ...
          return Object(u.a)(e2, [{ key: "init", value: function(e3) {
            ...
            this.prefix = t2.prefix || "i18next:", this.logger = e3 || p, this.options = t2, this.debug = t2.debug;
        ...
        var I = "undefined" != typeof window && window.navigator && window.navigator.userAgent && window.navigator.userAgent.indexOf("MSIE") > -1, L = function(e2) {
          ...
          return h(t2, e2), Object(u.a)(t2, [{ key: "changeLanguage", value: function(e3) {
            ...
            if (f2 && "cimode" === f2.toLowerCase()) {
              if (h2) {
                var p2 = n2.nsSeparator || this.options.nsSeparator;
                return d2 + p2 + c2;
              }
              return c2;
            }
        ...
        createElementVNode("div", _hoisted_2$1, [
          createElementVNode("div", _hoisted_3$1, [
            createElementVNode("div", _hoisted_4$1, [
              ...
              _cache[1] || (_cache[1] = createElementVNode("div", { class: "input-group-append" }, [
            ...
            createElementVNode("span", null, toDisplayString(search.value), 1)
          ]),
              ...
              createElementVNode("tbody", null, [
                (openBlock(true), createElementBlock(Fragment, null, renderList([...customerSearchResult.value.keys()], (zipCode) => {
                  return openBlock(), createElementBlock("tr", { key: zipCode }, [
                    createElementVNode("td", null, toDisplayString(zipCode), 1),
      ...
      return openBlock(), createElementBlock("div", null, [
        createElementVNode("div", null, [
          errorData.value && displayErrors.value ? (openBlock(), createElementBlock("div", _hoisted_1, [
            createElementVNode("strong", null, "[Fehler] " + toDisplayString(errorData.value.timeStamp.toLocaleTimeString()), 1),
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(errorData.value.errorLines, (line) => {
              return openBlock(), createElementBlock("div", { key: line }, [
                createElementVNode("div", { innerHTML: line }, null, 8, _hoisted_2),
            ...
            createElementVNode("button", {
              ...
              createElementVNode("span", { "aria-hidden": "true" }, "×", -1)
            ]))
          ...
          createElementVNode("div", _hoisted_3, [
            ...
            createElementVNode("button", { onClick: logCurrent }, "Log current"),
            createElementVNode("button", {
          ...
          createElementVNode("div", _hoisted_8, [
            createElementVNode("div", _hoisted_9, [
              createElementVNode("div", _hoisted_10, [
                ...
                _cache[17] || (_cache[17] = createElementVNode("label", { for: "cbx_displayErrors" }, "Fehler anzeigen", -1))
              ])
            ]),
          ...
          unref(StoredData).currentAgentContact ? (openBlock(), createElementBlock("div", _hoisted_21, [
            createElementVNode("div", _hoisted_22, [
              ...
              withDirectives(createElementVNode("div", _hoisted_27, _cache[18] || (_cache[18] = [
                createElementVNode("span", null, "Links werden geladen", -1)
              ]), 512), [
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("main", null, [
        ...
        _cache[1] || (_cache[1] = createElementVNode("link", {
          rel: "stylesheet",
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-3772af4e"]]);
