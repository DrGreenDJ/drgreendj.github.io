...
class AgentContactWrapper {
  ...
  constructor(_contact) {
    ...
    __publicField(this, "areCaseLinksLoading", false);
  ...
  get customerString() {
    ...
    if (this.selectedCustomer !== null) {
      ...
      if ((customersWithFirstZipCode == null ? void 0 : customersWithFirstZipCode.length) === 1) customerToUse = customersWithFirstZipCode[0];
    }
    if (!customerToUse) {
      return "";
    }
...
class MerkurRequestHandler {
  static get _apiConfigForGet() {
    return {
      headers: {
  ...
  static searchCustomer(searchValue) {
    const amendedCustomerDict = /* @__PURE__ */ new Map();
    axios.get(`${this._apiUrl}/customer/search/all/${searchValue}?limit=20`, this._apiConfigForGet).then((result) => {
  ...
  static postCustomerData(customer, queueName, fromAddress, conversationUuid) {
  ...
  static assignContact(agentContact, customer) {
    ...
    const url = "";
    axios.post(url, agentContact.jsonPayload, this._apiConfig).then((response) => {
      StoredData.caseLinks = response.data.case_links;
    }).catch((reason) => {
  ...
  static assignNewContact(agentContact) {
    agentContact.areCaseLinksLoading = true;
  ...
  static finishContact(agentContact) {
    ...
    axios.put(
      `${this._apiUrl}/event/conversation/${agentContact.conversationUuid}/finish?customernumber=${((_a = agentContact.selectedCustomer) == null ? void 0 : _a.contract_number) ?? ""}&conversationtype=${agentContact.conversationTypeNumber}`,
      data,
      this._apiConfig
    ).then((response) => console.log(methodName, response)).catch((reason) => console.error(methodName, reason));
  }
  static setConversationUUid(agentContact) {
    let url = "/customer/";
    ...
    axios.get(this._apiUrl + url, this._apiConfigForGet).then((value) => {
...
__publicField(MerkurRequestHandler, "_apiKey", "");
__publicField(MerkurRequestHandler, "_apiUrl", "https://contactcenter.atliwest.local/rest/v1/merkurbooster");
class StoredData {
  static get crmUrl() {
    return "https://knowledge.atliwest.local/stoermeldungen_noc/";
  }
  //#region event handlers
  static addEventHandler(key, callback, isForCallsChanged) {
  ...
  static removeEventHandler(key, isForCallsChanged) {
    if (isForCallsChanged) {
  ...
  static addAgentContact(contact) {
    ...
    if (!this._currentAgentContact || newContact.mediaType === "telephony") {
  ...
  static removeAgentContact(interactionId) {
    ...
    const foundContactIdx = this._agentContacts.findIndex(
      (contact) => contact.interactionId === interactionId
    );
    if (foundContactIdx > -1) {
      if (this._agentContacts[foundContactIdx].interactionId === ((_a = this._currentAgentContact) == null ? void 0 : _a.interactionId)) {
        this.clearCurrent();
      }
  ...
  static setSelectedCustomer(interactionId, customer) {
    const foundContact = this.getAgentContactViaInteractionId(interactionId);
    if (!foundContact) {
      console.error(
  ...
  static _emitChange(isForCallsChanged) {
    const dictToCheck = isForCallsChanged ? this._eventHandlersCallsChanged : this._eventHandlersCurrentChanged;
    const keys = [...dictToCheck.keys()];
    keys.forEach((key) => {
      var _a;
      return (_a = dictToCheck.get(key)) == null ? void 0 : _a.call(null);
    });
  }
}
__publicField(StoredData, "agentEmailAddress", "");
__publicField(StoredData, "agentLoginId", "");
__publicField(StoredData, "_eventHandlersCallsChanged", /* @__PURE__ */ new Map());
__publicField(StoredData, "_eventHandlersCurrentChanged", /* @__PURE__ */ new Map());
//#endregion event handlers
//#region contacts / interaction
__publicField(StoredData, "_agentContacts", []);
__publicField(StoredData, "_currentAgentContact", null);
//#endregion contacts / interaction
__publicField(StoredData, "isInitialized", false);
__publicField(StoredData, "caseLinks", []);
__publicField(StoredData, "isLoading", false);
const _hoisted_1 = { class: "container" };
const _hoisted_2 = { key: 0 };
const _hoisted_3 = { key: 0 };
const _hoisted_4 = { class: "row justify-content-center mt-1 mb-1" };
const _hoisted_5 = {
...
const _hoisted_16 = { class: "col-12 mt-1 mb-1" };
const _hoisted_17 = { class: "col-12 mt-1 mb-1" };
const _hoisted_18 = { class: "col-12 mt-1 mb-1" };
const _hoisted_19 = { class: "col-12 mb-3 align-middle text-center" };
const _hoisted_20 = { class: "ml-2 mr-2 mt-3 mb-3" };
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const contactIncoming = ref(false);
    const pendingCustomerConfirmation = ref(false);
    const showSearch = computed(
      () => displaySearch.value || StoredData.currentAgentContact !== null && !pendingCustomerConfirmation.value
    );
    ...
    function getCrmUrl() {
      ...
      const url = `${StoredData.crmUrl}customer_view_finesse.php?debID=${(_c = (_b = StoredData.currentAgentContact) == null ? void 0 : _b.selectedCustomer) == null ? void 0 : _c.contract_number}&userID=${StoredData.agentLoginId}&navUser=${StoredData.agentEmailAddress}&conversationUuid=${(_d = StoredData.currentAgentContact) == null ? void 0 : _d.conversationUuid}&workItemUuid=${workItemUuid}`;
    ...
    function processCurrentChange() {
      ...
      contactIncoming.value = StoredData.currentAgentContact != null && StoredData.currentAgentContact.selectedCustomer == null;
      pendingCustomerConfirmation.value = ((_a = StoredData.currentAgentContact) == null ? void 0 : _a.selectedCustomer) === null && ((_b = StoredData.currentAgentContact) == null ? void 0 : _b.hasSingleHit);
    }
    ...
    return (_ctx, _cache) => {
      var _a, _b, _c;
      const _component_customerTable = resolveComponent("customerTable");
      return openBlock(), createElementBlock("div", _hoisted_1, [
        initialized.value ? (openBlock(), createElementBlock("div", _hoisted_2, [
          unref(StoredData).currentAgentContact ? (openBlock(), createElementBlock("label", _hoisted_3, toDisplayString(JSON.stringify(unref(StoredData).currentAgentContact)), 1)) : createCommentVNode("", true),
          createBaseVNode("div", _hoisted_4, [
            createBaseVNode("div", _hoisted_5, [
              createBaseVNode("div", _hoisted_6, [
                createBaseVNode("label", {
                  for: "callDropdown",
                  style: normalizeStyle({ fontWeight: calls.value.length > 0 ? "bold" : "unset" })
                }, "Anrufe (" + toDisplayString(calls.value.length) + ")", 5),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => selectedCallId.value = $event),
                  class: "form-control",
                  id: "callDropdown",
                  style: { "width": "100%" },
                  onChange: _cache[1] || (_cache[1] = ($event) => changeCurrent($event))
                }, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(calls.value, (item) => {
                    return openBlock(), createElementBlock("option", {
                      value: item.interactionId,
                      key: item.interactionId
                    }, toDisplayString(item.callLabel), 9, _hoisted_7);
                  }), 128))
                ], 544), [
            ...
            createBaseVNode("div", _hoisted_8, [
              createBaseVNode("div", _hoisted_9, [
                createBaseVNode("label", {
                  style: normalizeStyle({ fontWeight: emails.value.length > 0 ? "bold" : "unset" }),
                  for: "emailDropdown"
                }, "E-Mails (" + toDisplayString(emails.value.length) + ")", 5),
                withDirectives(createBaseVNode("select", {
                  "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => selectedEmailId.value = $event),
                  class: "form-control",
                  id: "emailDropdown",
                  style: { "width": "100%" },
                  onChange: _cache[3] || (_cache[3] = ($event) => changeCurrent($event))
                }, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(emails.value, (item) => {
                    return openBlock(), createElementBlock("option", {
                      value: item.interactionId,
                      key: item.interactionId
                    }, toDisplayString(item.mailLabel), 9, _hoisted_10);
                  }), 128))
                ], 544), [
            ...
            createBaseVNode("div", {
              ...
              createBaseVNode("div", { class: "col-12 mt-1 mb-1" }, [
                createBaseVNode("div", {
          ...
          !contactIncoming.value && frameSource.value ? (openBlock(), createElementBlock("div", _hoisted_11, [
            createBaseVNode("div", _hoisted_12, [
              createBaseVNode("iframe", {
                ...
                width: "90%",
                height: "775px",
                src: frameSource.value
              }, null, 8, _hoisted_13)
            ])
          ])) : createCommentVNode("", true),
          contactIncoming.value ? (openBlock(), createElementBlock("div", _hoisted_14, [
            createBaseVNode("div", _hoisted_15, [
              _cache[6] || (_cache[6] = createBaseVNode("div", { class: "col-12 mb-3 mt-4 align-middle text-center" }, [
                createBaseVNode("span", null, "Ist die Kundenauswahl korrekt?")
              ], -1)),
              ...
              createBaseVNode("div", _hoisted_17, [
                pendingCustomerConfirmation.value || ((_a = unref(StoredData).currentAgentContact) == null ? void 0 : _a.selectedCustomer) ? (openBlock(), createElementBlock("div", {
                  ...
                  onClick: _cache[4] || (_cache[4] = ($event) => displaySearch.value = true)
              ...
              withDirectives(createBaseVNode("div", _hoisted_19, _cache[5] || (_cache[5] = [
              ...
              createBaseVNode("div", _hoisted_20, [
                createBaseVNode("div", _hoisted_21, [
                  (openBlock(true), createElementBlock(Fragment, null, renderList((_c = unref(StoredData).currentAgentContact) == null ? void 0 : _c.caseLinks, (link, index) => {
                    return openBlock(), createElementBlock("div", {
                      ...
                      createBaseVNode("a", {
                        href: link.link,
                        target: "_blank"
                      }, toDisplayString(link.link_desc), 9, _hoisted_22)
                    ]);
                  }), 128))
                ])
              ])
            ]),
            unref(StoredData).currentAgentContact !== null ? (openBlock(), createElementBlock("div", _hoisted_23, [
              withDirectives(createVNode(_component_customerTable, {
                "conversation-uuid": unref(StoredData).currentAgentContact.conversationUuid
              }, null, 8, ["conversation-uuid"]), [
...
class ContactEventHandler {
  ...
  static _handleContactOffered(contact) {
...
const useStore = /* @__PURE__ */ defineStore("data", {
  state: () => ({
    initialized: false
  }),
  actions: {
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    if (!StoredData.isInitialized) {
      ...
      try {
        distExports.Desktop.config.init({ widgetName: "kundendaten-gadget", widgetProvider: "NTS" });
      } catch (ex) {
    ...
    function _setupEventListeners() {
      ...
      distExports.Desktop.agentStateInfo.addEventListener("updated", (data) => {
...
const App = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-a8c297fa"]]);
